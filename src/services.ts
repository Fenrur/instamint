...
export const profileService = new DefaultProfileService(pgClient, s3client, env.S3_BUCKET_NAME, 10)

export const nftService = new DefaultNftService(pgClient, 10)
