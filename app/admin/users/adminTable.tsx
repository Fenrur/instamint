...
import AdminDropDownMenu from "@/components/ui/adminDropDownMenu"
...
export const columns: ColumnDef<adminUsersType>[] = [
  {
    accessorKey: "isActivated",
    header: "enabled",
    cell: ({ row }) => (
      <div className="capitalize">{row.getValue("isActivated") === true ? (
        <CheckIcon/>
      ) : (<></>)}</div>
    ),
  },
